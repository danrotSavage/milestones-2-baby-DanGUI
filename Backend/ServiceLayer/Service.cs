...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class Service : IService
    {
        ...
        public Response LoadData()
        {
            try
            {
                uService.loadUsersData();
                bService.loadBoardsData(uService);
                log.Info("system loaded successfully");
                return new Response();
            }
            catch (KanbanException e)
            {
                log.Warn("could not load the system, Error:" + e.Message);
                return new Response(e.Message);
            }
            catch (Exception e)
            {
                log.Error("could not load the system, error:" + e.Message);
                return new Response(e.Message);
            }
        }
        ...
        {
            Response rtn = uService.DeleteData();
            Response rtn2 = bService.DeleteData();
            if (rtn.ErrorOccured | rtn2.ErrorOccured)
            {
                log.Info("not all data has been deleted");
                return new Response(rtn.ErrorMessage + rtn2.ErrorMessage);
            }
            else
            {
        ...
        {
            Response rtn = uService.Register(email, password, nickname);
            if (rtn.ErrorOccured)
            {
                log.Info("user did not registered successfully");
                return new Response(rtn.ErrorMessage);
            }
            else
            {
                return bService.Register(email);
        ...
        {
            return bService.Register(email,password,nickname,emailHost);
        }
        ...
        {
            return bService.DeleteTask(email,columnOrdinal,taskId);
        }		
        ...
        {
            return bService.AddTask(email, title, description, dueDate);
        }
        ...
        {
            return bService.UpdateTaskTitle(email, columnOrdinal, taskId, title);
        }
        ...
        {
            return bService.AdvanceTask(email, columnOrdinal, taskId);
        }
        ...
        {
            return bService.GetColumn(email, columnName);
        }
        ...
        {
            return bService.GetColumn(email, columnOrdinal);
        }
        ...
        {
            return bService.RemoveColumn(email, columnOrdinal);
        }
        ...
        {
            return bService.AddColumn(email, columnOrdinal, Name);
